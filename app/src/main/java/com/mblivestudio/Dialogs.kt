...
internal fun MainActivity.showGoLiveDialog() {
    ...
    listOf(etTitle, etDesc, spinner, sectionTitle, TextView(this).apply { text = "Resolution:" }, resSpinner, TextView(this).apply { text = "Frame Rate:" }, fpsSpinner, TextView(this).apply { text = "Bitrate:" }, bitSpinner, btnTime, thumbWrapper, btnThumbnail, btnConfirmLive).forEach { 

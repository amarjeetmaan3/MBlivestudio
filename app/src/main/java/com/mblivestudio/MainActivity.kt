...
class MainActivity : Activity(), ConnectChecker, SurfaceHolder.Callback {
    ...
    // Change (a): Added new cameraLayoutFilter variable
    ...
    private fun startCameraPreview() {
        ...
        if (!rtmpCamera.isOnPreview) {
            ...
            // Change (b): Replaced single setFilter call with setFilter and addFilter combo
            if (isSuccess && aReady) {
    ...
    // Change (c): Added applyCameraLayout function

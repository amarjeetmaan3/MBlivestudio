...
    // 🌟 SMART AUTO-DETECT CAMERA ENGINE 🌟
    private fun startCameraPreview() { 
        if (!rtmpCamera.isOnPreview) { 
            var vReady = false
            
            // यह इंजन हाई क्वालिटी से लो क्वालिटी तक हर डिवाइस के लिए बेस्ट सेटिंग चेक करेगा
            val resolutions = arrayOf(
                Pair(1280, 720), // Standard HD
                Pair(854, 480),  // Widescreen SD
                Pair(640, 480),  // Standard Tablet Front Camera (4:3)
                Pair(640, 360),  // Low bandwidth Widescreen
                Pair(480, 360)   // Very old devices
            )
            
            for (res in resolutions) {
                try {
                    // 30 fps और डिवाइस के हिसाब से ऑटोमैटिक बिटरेट
            ...
            // अगर कोई भी कस्टम सेटिंग काम न करे, तो डिवाइस की डिफ़ॉल्ट सेटिंग यूज़ करो
            if (!vReady) {
    ...
    // इसे onCreate के अंदर जहाँ btnSwitchCamera.setOnClickListener है, वहाँ रिप्लेस करें
    /*
        btnSwitchCamera.setOnClickListener { 
            try {
                rtmpCamera.switchCamera()
                // फ्लिप करने के बाद अगर कैमरे का रेजोल्यूशन बदलता है, तो उसे रिफ्रेश करें
                if (!rtmpCamera.isStreaming) {
